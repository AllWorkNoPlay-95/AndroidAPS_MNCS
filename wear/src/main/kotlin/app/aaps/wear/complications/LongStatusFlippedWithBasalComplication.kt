 ...
 */
class LongStatusFlippedWithBasalComplication : BaseComplicationProviderService() {
    ...
    override fun getProviderCanonicalName(): String = LongStatusFlippedWithBasalComplication::class.java.canonicalName!!
